...
class BdevsClients extends \Elementor\Widget_Base {
		...
		$this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name'    => 'client_logo',
                        'label'   => esc_html__( 'Client Logo', 'bdevs-elementor' ),
	...
	public function render() {
		...
		<div class="foliox_tm_section">
			<div class="foliox_tm_partners">
				<div class="container">
					<div class="partners_list tilt-effect wow fadeInUp" data-wow-duration="1s">
						<ul class="owl-carousel">
							<?php foreach ( $settings['tabs'] as $item ) : ?>
							<li class="item">
								<img src="<?php echo wp_kses_post($item['client_logo']['url']); ?>" alt="" />
							</li>
							<?php endforeach; ?> 
						</ul>
					</div>
