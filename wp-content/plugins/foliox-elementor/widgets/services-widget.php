...
class BdevsServices extends \Elementor\Widget_Base {
    ...
    extract($settings); ?>
    <div class="foliox_tm_section" id="service">
        <div class="foliox_tm_services">
            <div class="container">
                ...
                <div class="list">
                    <ul>
                        ...
                        ?>
                        <li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="<?php echo  $i; ?>s">
                            <div class="list_inner tilt-effect">
                                <?php if(isset($item['image_icon']['url']) && $item['image_icon']['url'] != ''){?>
                                <span class="icon"><img class="svg" src="<?php echo wp_kses_post($item['image_icon']['url']); ?>" alt="" /></span>
                                <?php } ?>
                                <?php if(isset($item['title']) && $item['title'] != ''){?>
                                <h3 class="title"><?php print wp_kses_post($item['title']); ?></h3>
                                <?php } ?>
