        ...
        <?php } ?>
            <div class="container">
                <div class="foliox_tm_main_title">
                    <div class="title">
                        <h1><?php printf( esc_html__( 'Search Results for: %s', 'foliox' ), get_search_query() ); ?></h1>
                    </div>
                </div>
                <div class="content">
                    <div class="breadcrumbs">
                        ...
                        ?></a></span> / <span class="active"><?php echo esc_html__( 'Search Results', 'foliox' ); ?></span></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="list_inner blog_single_details">
                                <div class="search-custom" >
                                    <div class="post-text">
                                        ...
                                        echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'foliox' ) ;?></h4>
                                    </div>
                                    <?php get_search_form();  ?>
                                </div>
                            </div>
