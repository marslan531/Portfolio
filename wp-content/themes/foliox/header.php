        ...
        <div class="foliox_tm_header">
            <div class="container">
                <div class="inner header-top-fixed">
                    <div class="logo">
                        <?php if(isset($foliox_redux_demo['logo']['url']) && $foliox_redux_demo['logo']['url'] != ''){ ?>
                        <a class="anchor" href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url($foliox_redux_demo['logo']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>" /></a>
                        <?php } else { ?>
                        <a class="anchor" href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo get_template_directory_uri();?>/img/logo/logo.png" alt="<?php bloginfo( 'name' ); ?>" /></a>
                        <?php } ?>
                    </div>
                    <div class="details">
                        <div class="menu">
