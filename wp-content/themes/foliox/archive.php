            ...
            <div class="container">
                <div class="foliox_tm_main_title">
                    <div class="title">
                        <h1><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'foliox' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'foliox' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'foliox' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'foliox' ), get_the_date( _x( 'Y', 'yearly archives date format', 'foliox' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'foliox' );
                        endif; ?></h1>
                    </div>
                </div>
                <div class="content">
                    <div class="breadcrumbs">
                        ...
                        ?></a></span> / <span class="active"><?php echo esc_html__( 'Archives', 'foliox' ); ?></span></p>
                    </div>
                </div>
            </div>
        </div>
